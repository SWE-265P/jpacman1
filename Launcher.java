...
public class Launcher {
    ...
    protected void addSinglePlayerKeys(final PacManUiBuilder builder) {
        builder.addKey(KeyEvent.VK_DOWN, moveTowardsDirection(Direction.NORTH))
                .addKey(KeyEvent.VK_UP, moveTowardsDirection(Direction.SOUTH))
                .addKey(KeyEvent.VK_RIGHT, moveTowardsDirection(Direction.WEST))
                .addKey(KeyEvent.VK_LEFT, moveTowardsDirection(Direction.EAST));
    }
